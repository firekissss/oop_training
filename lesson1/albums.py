...
album_1 = Album("Queen", "Killer Queen", tracks=["Brighton rock", "Killer Queen", "Tenement Funster"])

album_2 = Album("Metallica", "Black Album", tracks=["Enter Sandman", "Sad But True", "Holier Than Thou"])
